...
public class PoliticalLeaderControllerTest {
	...
	public void testGetPoliticalLeaderById() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/leaders/leader/1").contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON);
	...
	public void testDeletePoliticalLeader() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/leaders/party/delete/1")
